...
# tokens. Qwen2.5-1.5B beat both 3B candidates on judged accuracy across
# all 8 categories, decodes ~1.5x faster on 2 vCPU (more tasks answered
# locally within the runtime budget), and halves peak RSS.
